...
export function PublicationOverview({ project }: { project?: Project }) {
  return (
    <section>
      <h2 className="mb-6 text-4xl font-medium">Abstract</h2>
      <p className="max-w-3xl text-[22px]">
        This dummy abstract shows where the publication summary will appear. The final text, DOI and
        external document link will come from Supabase.
      </p>
