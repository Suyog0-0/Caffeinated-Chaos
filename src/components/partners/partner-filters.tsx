...
export function PartnerFilters({
  ...
  return (
    <div className="flex flex-col gap-3 border-y border-neutral-300 bg-[#f4f2ec] px-6 py-5 md:flex-row md:items-center md:px-10 lg:px-16">
      ...
      <select
        ...
        className="w-full rounded-md border border-neutral-300 bg-white px-3 py-2 text-sm text-neutral-800 md:w-56"
      >
