              ...
              >
                <div className="flex items-center gap-4">
                  {person.photoUrl ? (
                    ...
                    <span
                      aria-hidden="true"
                      className="grid size-14 shrink-0 place-items-center rounded-full border border-[#28503f] bg-[#103327] text-sm font-medium text-[#47c97e]"
                    >
                      {person.initials}
                    </span>
                  )}
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 truncate text-[10px] font-bold uppercase tracking-[0.13em] text-[#47c97e] sm:text-[11px]">
                      {person.role}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-7 flex flex-1 flex-col">
                  ...
                  <span className="mt-8 inline-flex min-h-11 items-center gap-2 self-start text-xs font-semibold text-[#47c97e] transition-colors duration-200 group-hover:text-white">
