...
export function AboutHero() {
  return (
    <header className="mx-auto grid w-[min(calc(100%_-_48px),1240px)] grid-cols-[.85fr_1.15fr] items-center gap-[8vw] py-15 max-lg:grid-cols-1 max-sm:w-[calc(100%_-_32px)]">
      <div>
        <p className="mb-4 font-sans text-lg font-bold text-[#153c2e]">About R&amp;D</p>
        <h1 className="text-[clamp(54px,7vw,92px)] leading-[.94] font-normal tracking-[-.045em]">
          Curiosity with somewhere to go.
        </h1>
        <p className="mt-12 max-w-2xl text-xl text-[#405149]">
