// src/components/people/person-results.tsx
...
export async function PersonResults({
    ...
    // area filter isn't wired to a real column yet (see person-filters.tsx),
    // kept as a param for parity with the existing filter UI.
    void area;

    return <PersonList researchers={researchers} />;
}